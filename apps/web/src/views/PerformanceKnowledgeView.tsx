              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-700/50 pb-3">
                  <div>
                    ...
                    <div className="text-2xl font-bold font-mono text-emerald-400">{v.averageScore} / 100</div>
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-700/50 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold text-lg">{fb.overallRating}.0 / 5.0</span>
                  </div>
