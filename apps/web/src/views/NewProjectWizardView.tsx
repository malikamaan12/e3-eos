...
export const NewProjectWizardView: React.FC = () => {
  ...
  const [code, setCode] = useState<string>(`PRJ-${new Date().getFullYear()}-DEMO`);
  const [title, setTitle] = useState<string>('Qatar Tourism Demo Tender');
  const [description, setDescription] = useState<string>('Comprehensive end-to-end turnkey event management for international tourism showcase in Doha.');
    ...
    try {
      ...
      const payload = {
        ...
        commercialStartingPoint: {
          classificationTag: commercialTag,
          revenueValue: estimatedValue,
          targetMargin,
          currency,
        },
        team: {
      ...
      <Card>
        ...
        {currentStep === 1 && (
          <div>
            ...
            <p style={{ margin: '0 0 18px', fontSize: '13px', color: '#64748b' }}>
              How did this project opportunity originate? This configures the initial lifecycle and governance milestones.
            </p>
        ...
        {currentStep === 2 && (
          <div>
            ...
            <p style={{ margin: '0 0 18px', fontSize: '13px', color: '#64748b' }}>
              Provide the foundational identity and event format classifications.
            </p>
        ...
        {currentStep === 8 && (
          <div>
            <h3 style={{ margin: '0 0 4px', fontSize: '16px', fontWeight: 700, color: '#0f172a' }}>
              Step 8: Canonical 13-Stage Workflow
            </h3>
            <p style={{ margin: '0 0 18px', fontSize: '13px', color: '#64748b' }}>
              The standard E3 13-stage lifecycle template will be instantiated for this project.
            </p>

            <div style={{ maxHeight: '280px', overflowY: 'auto', border: '1px solid #e2e8f0', borderRadius: '6px' }}>
              {[
                'Stage 01: Strategic Intake & Feasibility Assessment',
                'Stage 02: Commercial Proposal & Bid Pricing',
                'Stage 03: Four-Eyes Executive Gate Sign-off',
                'Stage 04: Client Contracting & PO Issuance',
                'Stage 05: Creative Concept & 3D Spatial Renders',
                'Stage 06: Technical Production & Structural CAD Rigging',
                'Stage 07: Procurement Packages & Contractor Call-offs',
                'Stage 08: Logistics Dispatch & Asset Allocation',
                'Stage 09: Civil Defence & HSE Zone Safety Clearance',
                'Stage 10: Technical Readiness & Rehearsals',
                'Stage 11: Live Event Operational Delivery',
                'Stage 12: Strike, Bump-out & Venue Handover',
                'Stage 13: Financial Closeout, EAC Finalization & Debrief',
              ].map((stageName, idx) => (
                <div
                  key={idx}
                  style={{
                ...
                >
                  <span style={{ fontWeight: 600, color: '#1e293b' }}>{stageName}</span>
        ...
        {currentStep === 9 && (
          <div>
            ...
            <p style={{ margin: '0 0 18px', fontSize: '13px', color: '#64748b' }}>
              Review the project parameters before persisting directly to PostgreSQL Cloud SQL.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
              ...
              <div style={{ backgroundColor: '#f8fafc', padding: '12px', borderRadius: '6px' }}>
                ...
                <div style={{ fontSize: '12px', color: '#64748b' }}>{clientContact}</div>
              </div>

              <div style={{ backgroundColor: '#f8fafc', padding: '12px', borderRadius: '6px' }}>
                <div style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase' }}>Estimated Value</div>
                <div style={{ fontSize: '14px', fontWeight: 700, color: '#059669' }}>{estimatedValue} {currency}</div>
                <div style={{ fontSize: '12px', color: '#64748b' }}>Target Margin: {targetMargin} ({commercialTag})</div>
              </div>

              <div style={{ backgroundColor: '#f8fafc', padding: '12px', borderRadius: '6px' }}>
                <div style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase' }}>Venue & Key Dates</div>
                <div style={{ fontSize: '13px', fontWeight: 600, color: '#0f172a' }}>{venueName}</div>
                <div style={{ fontSize: '12px', color: '#64748b' }}>Submission: {submissionDeadline} • Live: {eventDate}</div>
              </div>
            </div>

            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Badge variant="success">All Invariants Checked</Badge>
              <span style={{ fontSize: '12px', color: '#64748b' }}>Ready to instantiate in staging PostgreSQL.</span>
            </div>
          </div>
        )}
