...
const initialConnections: ProviderConnectionDto[] = [
  ...
  },
  {
    id: 'conn-e3-rentals',
    provider: 'e3_rentals',
    label: 'E3 Rentals Inventory & Asset Authority',
    accountOrProjectId: 'e3-rentals-sandbox',
    approvedEndpoint: 'https://rentals.internal.e3.qa/api/v1',
    approvedRegion: 'me-central1-doha',
    secretStatus: 'not_configured',
    maskedSecret: '••••••••••••••••',
    health: 'not_tested',
    mode: 'disabled',
    capabilities: ['read_catalog', 'availability_query', 'internal_reservation', 'movement_sync'],
    isDefault: false,
  },
  {
    id: 'conn-e3-purchasetracker',
    provider: 'e3_purchasetracker',
    label: 'E3 PurchaseTracker Procurement Authority',
    accountOrProjectId: 'e3-purchasetracker-sandbox',
    approvedEndpoint: 'https://purchase-tracker.internal.e3.qa/api/v1',
    approvedRegion: 'me-central1-doha',
    secretStatus: 'not_configured',
    maskedSecret: '••••••••••••••••',
    health: 'not_tested',
    mode: 'disabled',
    capabilities: ['vendor_search', 'vendor_onboarding', 'pr_create', 'pr_submit'],
    isDefault: false,
  },
];
