  ...
  getFinancials(
    ...
    return {
      data: {
        ...
        payload: {
          currency,
          baselineBudget: financials.baselineBudget.toString(),
          approvedChanges: financials.approvedChanges.toString(),
          currentBudget: financials.currentBudget.toString(),
          committedCost: financials.committedCost.toString(),
          actualCost: financials.actualCost.toString(),
          forecastToComplete: financials.forecastToComplete.toString(),
          estimateAtCompletion: financials.estimateAtCompletion.toString(),
          varianceAtCompletion: financials.varianceAtCompletion.toString(),
          pendingExposureCost: financials.pendingExposureCost.toString(),
          pendingExposureSell: financials.pendingExposureSell.toString(),
          baselineContractValue: financials.baselineContractValue.toString(),
          approvedChangesSell: financials.approvedChangesSell.toString(),
          approvedContractValue: financials.approvedContractValue.toString(),
          unapprovedExposureScenarioEac: financials.unapprovedExposureScenarioEac.toString(),
          // Backwards compatibility
          approvedCostBudget: financials.currentBudget.toString(),
          totalForecastCost: financials.estimateAtCompletion.toString(),
